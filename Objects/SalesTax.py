...
class PurchasedGood:
    ...
    #For our constructor, we use the same syntax we used for functions:
    #all methods have self as the first parameter, and then the others
    #can be keyword parameters with the given default values:
    def __init__(self, price, category = "General", tax = 0.07):
        self.price = price
        self.category = category
        self.tax = tax
        
    #The calculate_total method multiplies the price by the tax.
    #It then rounds the result to 2 decimal places as instructed.
    def calculate_total(self):
