...
#The first section of this problem follows the template
#you've seen so far:
class Pokemon:
    def __init__(self, name, power):
        self.name = name
    ...
    #The trick here is the would_defeat method. Like all
    #methods, it would take self as its first parameter.
    #As its second parameter, it would take _another_
    #instance of Pokemon:
    def would_defeat(self, other_pokemon):
        
        #Now, what are we comparing? We're comparing this
        #Pokemon's power, represented by self.power, to the
        #other Pokemon's power. We access that with
        #other_pokemon.power:
