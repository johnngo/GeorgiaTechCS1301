...
beats = [72, 77, 79, 95, 102, 105, 112, 115, 120, 121, 121, 125, 125, 123, 119, 115, 105, 101, 96, 92, 90, 85]
...
#The problem said that we could assume that all values over
#100 would happen consecutively. That carries an underlying
#useful implication for us: we can assume that _any_ value
#over 100 can be added, and _any_ value under 100 should not
#be.
#
#So, with that implication in mind, the problem becomes:
#average all numbers over 100 in the list. That's easier.
#
